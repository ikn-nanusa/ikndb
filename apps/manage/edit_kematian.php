<?php
$id_jmt = $_GET['id_jmt'];
$query = mysqli_query($koneksi, "SELECT * FROM tbl_jemaat INNER JOIN tbl_keluarga ON tbl_jemaat.keluarga=tbl_keluarga.nama_kel WHERE id_jmt='$id_jmt' ; ");
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" hidden>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tglahir" value="<?php echo $view['tglahir']; ?>">
                                </div>
                            </div>
                            <div class="col-md-6" hidden>
                                <!-- select -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tglmeninggal">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <!-- text input -->
