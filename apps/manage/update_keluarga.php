...
$sql = "UPDATE IGNORE tbl_keluarga SET nama_kel='$nama_kel', kepala='$kepala_kel', tglnikah='$tglnikah', alamat='$alamat', propinsi='$propinsi', kodepos='$kodepos', telepon='$telepon', stat_kel='$stat_kel', info_kel='$info_kel',update_by='$adm',update_time=CURRENT_TIMESTAMP WHERE id_kel='$id_kel'";
