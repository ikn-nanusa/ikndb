            ...
            <div class="card-body">
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-item nav-link active" id="custom-nav-a-tab" data-toggle="tab" href="#custom-nav-a" role="tab" aria-controls="custom-nav-a" aria-selected="true"><b>Data Keluarga Aktif</b></a>
                  <a class="nav-item nav-link" id="custom-nav-b-tab" data-toggle="tab" href="#custom-nav-b" role="tab" aria-controls="custom-nav-b" aria-selected="false"><b>Data Keluarga Tidak Aktif</b></a>
                </div>
              </nav>
                    ...
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php
                          $no = 0;
                          $query = mysqli_query($koneksi, "SELECT * FROM tbl_keluarga WHERE stat_kel = 'Aktif'");
                    ...
                    <div class="card-body ">
                      <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php
                          $no = 0;
                          $query = mysqli_query($koneksi, "SELECT * FROM tbl_keluarga WHERE stat_kel = 'Tidak Aktif'");
                          while ($kel = mysqli_fetch_array($query)) {
                            $no++
                          ?>
                            <tr>
          ...
          <div class="modal-body">
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="date" class="form-control" id="tglnikah" name="tglnikah" placeholder="YYYY-MM-DD">
              </div>
