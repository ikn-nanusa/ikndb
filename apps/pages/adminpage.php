                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="custom-select" name="level">
                                    ...
                                    <option value="admkwp1">admkwp1</option>
                                    <option value="admkwp2">admkwp2</option>
                                    <option value="admkwp3">admkwp3</option>
                                    <option value="admkwp4">admkwp4</option>
                                    <option value="admkwp5">admkwp5</option>
                                    <option value="admkwp6">admkwp6</option>
                                    <option value="admkwp7">admkwp7</option>
                                    <option value="admkwp8">admkwp8</option>
                                    <option value="admkwp9">admkwp9</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
