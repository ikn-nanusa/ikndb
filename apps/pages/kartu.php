            ...
            <div class="row">
                ...
                <div class="col-md-10">
                                    ...
                                    <div>
                                        <div class="card-body">
                                            <table id="table" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = mysqli_query($koneksi, "SELECT *, TIMESTAMPDIFF(YEAR, tbl_jemaat.tglahir, CURDATE()) AS usia FROM tbl_jemaat INNER JOIN tbl_keluarga 
                    ...
                    <div style="display: flex; justify-content: flex-end" class="center">
                        <tr>
                            <p>
                                <td><button type="button" class="btn btn-danger"><a href="pages/cetak_kartu.php?&&id_kel=<?php echo $view['id_kel']; ?>" style=" color:#ffffff;" target=" _self">CETAK</a></button></td>
                            </p>
                        </tr>
                    </div>
                    <!-- /.card -->
